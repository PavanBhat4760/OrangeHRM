...
@Test
public class VisaImmigration extends Login {
	...
	public void immegration() {
		...
		WebElement radiobutton = driver.findElement(By.xpath("(//span[@class='oxd-radio-input oxd-radio-input--active --label-right oxd-radio-input'])[2]"));
		radiobutton.click();
		System.out.println("Radio button clicked");

		WebElement number = driver.findElement(By.xpath(" (//input[@class='oxd-input oxd-input--active'])[2]"));
		number.click();
		number.sendKeys("A11423");
		...
		save.click();
		System.out.println("Visa immigration detail sucessfully aaded");    
